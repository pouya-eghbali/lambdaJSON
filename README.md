...
lambdaJSON
===========
Serialize python standard types (function, tuple, complex, set, frozenset, range, bytearray, bytes, dict with number keys, byte keys or tuple keys, and etc) with json.
